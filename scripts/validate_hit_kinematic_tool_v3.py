...
def physics_step(scene):
    # 在 physics step 前给 kinematic striker
    # 下一个 EE-follow target。
    sync_left_tool_target()

    # 这是整个文件唯一真正调用 PhysX step 的地方。
    scene.step()

    # step 后测量实际 EE-tool 偏差，
    # 再预置下一步 target。
    error = measure_left_tool_follow_error()
...
def main():
    print("\n==============================================")
    print("HIT KINEMATIC TOOL V3 / KINEMATIC RESTORE GATE")
    print("==============================================\n")
